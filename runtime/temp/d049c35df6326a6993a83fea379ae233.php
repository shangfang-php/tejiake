<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp\www\tejiake\public/../application/index\view\index\index.html";i:1501745318;s:71:"D:\wamp\www\tejiake\public/../application/index\view\public\header.html";i:1501817861;s:71:"D:\wamp\www\tejiake\public/../application/index\view\public\footer.html";i:1501818331;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="con">
    <div class="content">
        <div class="hot">
            <img src="/static/index/images/baokuan.png" alt="爆款单" style="padding-top: 64px">
            <span class="f12">
        ...
        <div class="hot-dec">
            <div class="hot-box">
                <p>
                    我们会把全网所有优惠券产品汇集起来
                    <br/>
                    然后检测单日领券量在3000张以上或者隔天5000张券以上
                    <br/>
                    爆款领券量、出单转化率等多个维度进行每日实时排行！
                </p>
            </div>
        </div>
        <div class="good">
                ...
                <ul>
                    ...
                    <li data_id="<?php echo $val['id']; ?>">
                        ...
                        <div class="good-price">
                            ...
                            <input class="fz fr copy f12" type="button" value=" 复制文案">
                            </input>
                        </div>
